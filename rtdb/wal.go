...
//Binary or JSON
const (
	// Binary format writes entries in binary. This is the default and, unless a good reason otherwise, should be used in production.
	Binary LogFormat = 0
	// JSON format writes entries as JSON lines. This causes larger, human readable files.
	JSON LogFormat = 1
)
